...
data_dir = os.path.join(script_dir, '../demo/metrics/takingPhoto.csv')
...
histogram_dir = os.path.join(script_dir, '../demo/metrics/takingPhotoHistogram.png')
